...
#asspre = pd.read_csv('/media/clm/' + USB + '/07-2016JAN30-printro/data/\
asspre = pd.read_csv('/media/clm/' + USB + '/07-2016JAN30-printro/data/\
ass.csv',
header = 0,
...
# ---EXAMEN---
exapre = pd.read_csv('/media/clm/' + USB + '/07-2016JAN30-printro/data/\
quiz.csv',
header = 0,
usecols = ['tipo', 'actdate', 'usrid', 'crsid', 'catid'], 
sep=',')
...
# ---FOROS---
foropre = pd.read_csv('/media/clm/' + USB + '/07-2016JAN30-printro/data/\
foro.csv',
header = 0,
usecols = ['tipo', 'actdate', 'usrid', 'crsid', 'catid'], 
sep=',')
...
usrintro = pd.read_csv('/media/clm/' + USB + '/07-2016JAN30-printro/data/\
...
'''
A16.to_csv("/media/clm/' + USB + '/07-2016JAN30-printro/data/\
...
usrevent2016 = pd.read_excel('/media/clm/' + USB + '/07-2016JAN30-printro/\
...
#NUNCAS
# Leemos los nuncas
nuncaspre = pd.read_csv('/media/clm/' + USB + '/05-2016DEC19-churn/data/nuncas_c_introd.txt',
header = 0,
usecols = ['usrid', 'crsid'],  
sep='|')
...
matints = pd.read_csv('/media/clm/' + USB + '/04-2016DEC02-tiempos_de_vida/data/matints.csv',
header = 0,
...
fecini = pd.read_excel('/media/clm/' + USB + '/04-2016DEC02-tiempos_de_vida/data/materias_introductorias.xlsx',
...
usr = pd.read_csv('/media/clm/' + USB + '/04-2016DEC02-tiempos_de_vida/data/tmpo_vida01-full_v2.csv',
header = 0,
sep=',')
